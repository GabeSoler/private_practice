...
def room_calendars_view(request):
    ...
    return render(request,"calendar_app/upcoming_by_event_type.html",context)
...
def event_listing(request):
    ...
    context = events
    return render(request, "calendar_app/event_list.html", context) #todo check template
...
def event_view(request,event_pk):
    ...
    recurrence_form_class=MultipleOccurrenceForm,
    template="swingtime/event_detail.html",
